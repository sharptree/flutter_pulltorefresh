        ...
        BottomNavigationBar(
          items: [
            BottomNavigationBarItem(
                icon: Icon(Icons.home, color: tabIndex == 0 ? Colors.blue : Colors.grey), label: 'Example1'),
            BottomNavigationBarItem(
                icon: Icon(Icons.cloud, color: tabIndex == 1 ? Colors.blue : Colors.grey), label: 'Example2'),
            BottomNavigationBarItem(
                icon: Icon(Icons.call, color: tabIndex == 2 ? Colors.blue : Colors.grey), label: 'Example3'),
            BottomNavigationBarItem(
                icon: Icon(Icons.transform, color: tabIndex == 3 ? Colors.blue : Colors.grey), label: 'Example4'),
          ],
          onTap: (index) {
